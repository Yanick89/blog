...
<form class="flex flex-col md:flex-row container w-full mx-auto gap-5 max-w-3xl">
    ...
    <div class="space-y-12 w-full">
                        ...
                        <div class="w-full px-4 py-2 sm:col-span-3 sm:gap-4 sm:px-0">
                            <div class="col-span-full ">
                                <div class="flex border-0 rounded-l-md shadow-sm ring-1 ring-inset ring-gray-300">
                                    ...
                                    <input type="text" name="url" id="url"  class="flex flex-1 border-0 py-1.5 rounded-r-md text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 placeholder:font-medium focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 px-3" placeholder="https://">
                                </div>
                            </div>
                        </div>
                        <div class="w-full px-4 py-2 sm:col-span-3 sm:gap-4 sm:px-0">
        ...
        <div class="mb-6 flex items-center justify-end gap-x-6">
            <button type="submit" class="bg-gray-700 text-white hover:bg-gray-500 rounded-md px-3 py-2 text-sm font-medium">Modifier</button>
        </div>
    </div>
</form>
