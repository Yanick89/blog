...
<div id="editorjs">
    <div class="mx-auto w-full max-w-[650px]">
        ...
        <!-- <div class="flex items-center justify-center w-full">
            <label for="imageUrl" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                ...
                <input id="imageUrl" type="file" accept=".jpg, .jpeg, .png, .gif, .webp, image/*" class="hidden" on:change={imageSelected} />
            </label>
        </div>  -->
